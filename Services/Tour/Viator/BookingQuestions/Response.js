...
const response = {
    // Get booking questions response from viator 
    getBookingQuestionsCacheApiReponse: async (clientId, providerDetails, url, request) => {
        let fName = "BookingQuestionCache_ApiResponse_";
